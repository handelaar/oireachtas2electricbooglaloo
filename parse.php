...
$properties = array (
        ...
        oral-qnum       => '1',                                         # Optional. QNum from order paper
...
function make_speech($properties) {
        ...
        $attrs  .= " speakerid=\"" . $properties["speakerid"] . "\""
        $attrs  .= " speakername=\"" . $properties["speakername"] . "\"";

        # Optional attrs (next line may acquire more as we discover them)
